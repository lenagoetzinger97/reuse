  ...
  <div>
    <div>
      ...
      <div class="container-herotext">
        ...
        <p class="p-large text-center">Einstellungen zum Thema Abfallvermeidung und Nachhaltigkeit</p>
        <p class="text-center">Semesterarbeit im Kurs Interaktives Informationsdesign des Fachbereichs Onlinemedien 2021 von Nathalie Wiesler, Ronja Walter, Lena Götzinger, Lena Frerichs und Julia Fischinger </p>
      </div>
      <div class="container-speechbubbles">
        <img src="../assets/speechbubble-1.svg" alt="Menge von Leuten">
        <img src="../assets/speechbubble-2.svg" alt="Menge von Leuten">
        <img src="../assets/speechbubble-3.svg" alt="Menge von Leuten">
      </div>
      <div class="row-full">
    ...
    <div class="container-ziel-studie">
      <div class="container-text">
        ...
        <p>In Deutschland verursacht jeder Bewohner durchschnittlich 535 kg Abfälle pro Jahr. Dazu kommen Abfälle, die bei
          ...
          kg jährlich. Die zugrunde liegende Studie versucht, die Beweggründe für den Umgang mit Secondhand-Produkten zu verstehen,
    ...
    <div class="background_red">
        ...
        <p>Die Daten der Studie wurden mittels einer Online-Befragung erhoben. Die Teilnehmer konnten den Aussagen entweder
          voll und ganz zustimmen oder eher zustimmen.</p>
        <p>An der Studie nahmen insgesamt 1.023 Personen aus Deutschland teil, sodass die Stichprobe in Hinblick auf Alter,
    ...
    <p class="text-center p-large">Der Grad der Zustimmung dieser Aussagen wird in der folgenden Datenansicht in drei Kategorien betrachtet.</p>
